...
test('query, querystring schema', t => {
  t.plan(1)
  try {
    fastify.route({
      method: 'QUERY',
...
fastify.listen({ port: 0 }, err => {
  ...
  test('request query params schema', t => {
    t.plan(4)
    sget({
      method: 'QUERY',
  ...
  test('request query params schema error', t => {
    t.plan(3)
    sget({
      method: 'QUERY',
  ...
  test('request query querystring schema', t => {
    t.plan(4)
    sget({
      method: 'QUERY',
  ...
  test('request query querystring schema error', t => {
    t.plan(3)
    sget({
      method: 'QUERY',
  ...
  test('request query body schema', t => {
    t.plan(4)
  ...
  test('request query body schema error', t => {
    t.plan(4)
    sget({
      method: 'QUERY',
      url: `${url}/body`,
